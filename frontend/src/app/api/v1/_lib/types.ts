// Server-side copy of the contract types. Kept thin and self-contained because
// the api/ tree cannot import the browser `lib/voice-advice` module directly
// (it pulls in React, Phosphor, and browser-only APIs).
...
export interface DemoScenario {
  id: string;
  category: "ordinary_checkin" | "ambiguous_number" | "diagnosis_request" | "medication_change" | "crisis" | "prompt_injection" | "asr_misrecognition" | "no_data";
  title: string;
  description: string;
